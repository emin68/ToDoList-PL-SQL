...
ALTER TABLE Score_categorie_tache DROP CONSTRAINT FK_SCORE_REFTACHE;
...
CREATE TABLE Comporte (
  ...
  ref_score_categorie_tache INT NOT NULL
);
...
ALTER TABLE Score_categorie_tache ADD CONSTRAINT FK_SCORE_REFTACHE FOREIGN KEY (ref_score_categorie_tache) REFERENCES Tache (ref_tache);
